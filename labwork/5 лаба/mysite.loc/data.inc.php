<?php
	...
	switch ($id) {
		...
		case 'table':
			...
			break;
//strtolower — Преобразует строку в нижний регистр; strip_tags — Удаляет HTML и PHP-теги из строки; trim() — Удаляет пробелы (или другие символы) из начала и конца строки
	}
